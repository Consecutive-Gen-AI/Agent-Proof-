...
class RelationType(str, Enum):
    ...
    VALIDATED_BY = "VALIDATED_BY"# CHANGE -> CHECK or CHANGE -> ATTACK_CASE
    CHALLENGES = "CHALLENGES"    # ATTACK_CASE -> SYMBOL or ATTACK_CASE -> FILE
    PRODUCES = "PRODUCES"        # CHECK -> EVIDENCE or ATTACK_CASE -> EVIDENCE
    SUPPORTS = "SUPPORTS"        # EVIDENCE -> VERDICT or EVIDENCE -> FINDING
    TRIGGERS = "TRIGGERS"        # EVIDENCE/CHANGE -> FINDINGS
    AFFECTS = "AFFECTS"          # FINDING -> VERDICT or CHECK/EVIDENCE -> VERDICT
